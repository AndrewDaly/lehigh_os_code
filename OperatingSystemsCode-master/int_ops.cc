 ...
 * function.
 *
 * NB: the C++ sort algorithm is better, because it uses C++ templates,  can get
 *     inlined more effectively.  This qsort() function will actually make
 ...
 *
 * @returns index at which key can be found, or -1
 */
